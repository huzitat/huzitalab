...
里山との関わりや利用などについてお尋ねするアンケートです。

アンケートの最後に、**マツタケ探索会への参加・不参加**をお尋ねします。

ご覧になった案内に応じて、該当するアンケートにご回答ください。
...
マツタケ探索会への参加・不参加についても、アンケートの最後にお尋ねします。

[**回覧・自治会アンケートに回答する →**](https://forms.gle/CjbE86nnX8LEZTKM7)

すでにアンケートに回答された方は、再度ご回答いただく必要はありません。


### 回覧・自治会アンケートをご覧になっていない方

このページなどからマツタケ探索会を知った方は、下記のアンケートにご回答ください。

マツタケ探索会への参加・不参加についても、アンケートの最後にお尋ねします。

[**里山に関するアンケートに回答する →**](https://docs.google.com/forms/d/e/1FAIpQLSetWhEC93179z3FJp9qvX5O6ndGyMapNl31PXpkUY9GW83wWQ/viewform?usp=header)
